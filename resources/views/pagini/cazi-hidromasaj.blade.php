@extends('layouts.app')
@section('title', 'Cazi Hidromasaj & SPA')
@section('description', 'Cazi de hidromasaj si SPA: portabile, incorporate sau publice. Relaxare completa acasa sau la hotel.')
...
<div class="pr-page-hero">
    ...
    <h1>Cazi hidromasaj &amp; SPA</h1>
    <p>Relaxare completa acasa. De la SPA portabil la sisteme incorporate de lux, avem solutia perfecta pentru nevoile tale.</p>
</div>
        ...
        <div style="display:grid; grid-template-columns:repeat(2, minmax(0, 400px)); gap:32px;">
            ...
            <div style="background:#fff; border-radius:16px; overflow:hidden; box-shadow:0 2px 16px rgba(10,37,64,0.08); border:1px solid var(--gray-light);">
                ...
                <div style="padding:20px 24px 24px;">
                    ...
                    <a href="{{ route('page.cazi.spa', $item['slug']) }}" style="font-size:13px; font-weight:700; color:var(--aqua); text-decoration:none; font-family:'Outfit',sans-serif;">Detalii &rarr;</a>
                </div>
            </div>
            @endforeach
...
<div class="pr-page-cta">
    <div>
        <h3>Nu stiti ce tip de SPA vi se potriveste?</h3>
        <p>Consultantii nostri va ghideaza spre solutia ideala pentru spatiul si bugetul dvs.</p>
    </div>
