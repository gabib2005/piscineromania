@extends('layouts.app')
@section('title', 'Servicii Piscine — Intretinere & Service')
...
<div style="background: linear-gradient(135deg, var(--navy) 0%, #0d3059 100%); color:#fff; padding:64px 72px 56px;">
    <div style="max-width:700px;">
        <div style="display:flex; align-items:center; gap:8px; margin-bottom:16px; font-size:12px; opacity:0.7; font-family:'Outfit',sans-serif;">
            <a href="{{ route('page.piscine') }}" style="color:#fff; text-decoration:none;">Piscine</a>
...
<div style="max-width:1100px; margin:0 auto; padding:56px 72px;">
    ...
    <div style="text-align:center;">
        ...
        <div style="margin-top:36px;">
            <a href="{{ route('page.contact') }}" style="display:inline-block; background:var(--aqua); color:#fff; padding:14px 32px; border-radius:50px; font-weight:700; font-size:14px; text-decoration:none; font-family:'Outfit',sans-serif;">
